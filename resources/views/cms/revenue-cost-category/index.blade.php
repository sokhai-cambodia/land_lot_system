...
<section class="content">
    <div class="card">
        <div class="card-header">
            ...
            <a href="{{ UtilHelper::route('revenue-cost.category.create') }}" class="btn btn-outline-success btn-flat float-right">Create</a>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
...
<script>
    $(function () {
        $('#dt').DataTable({
            ...
            'serverMethod': 'post',
            'ajax': {
                'url': "{{ route('revenue-cost.category.data-table') }}",
                "data": {
                    "_token": "{{ csrf_token() }}",
                },
            },
