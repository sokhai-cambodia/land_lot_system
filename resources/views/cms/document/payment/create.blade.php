            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        ...
                        <a href="{{ UtilHelper::route('document.payment', ['paymentId' => $paymentId]) }}" class="btn btn-outline-success btn-flat float-right">Document Payment List</a>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" action="{{ route('document.payment.create', ['paymentId' => $paymentId]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
