...
<section class="content">
    <div class="card">
        <div class="card-header">
            ...
            <a href="{{ UtilHelper::route('document.payment.create', ['paymentId' => $payment->id]) }}" class="btn btn-outline-success btn-flat float-right">Upload</a>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
...
<script>
    $(function () {
        ...
        $('#dt').DataTable({
            ...
            'serverMethod': 'post',
            'ajax': {
                'url': "{{ route('document.payment.data-table', ['paymentId' => $payment->id]) }}",
                "data": {
                    "_token": "{{ csrf_token() }}",
                },
            },
