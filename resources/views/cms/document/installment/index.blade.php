...
<section class="content">
    <div class="card">
        <div class="card-header">
            ...
            <a href="{{ UtilHelper::route('document.installment.create', ['installmentId' => $installment->id]) }}" class="btn btn-outline-success btn-flat float-right">Upload</a>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
...
<script>
    $(function () {
        ...
        $('#dt').DataTable({
            ...
            'serverMethod': 'post',
            'ajax': {
                'url': "{{ route('document.installment.data-table', ['installmentId' => $installment->id]) }}",
                "data": {
                    "_token": "{{ csrf_token() }}",
                },
            },
