...
<section class="content">
    <div class="card">
        <div class="card-header">
            ...
            <a href="{{ UtilHelper::route('document.process.create', ['processId' => $process->id]) }}" class="btn btn-outline-success btn-flat float-right">Upload</a>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
...
<script>
    $(function () {
        ...
        $('#dt').DataTable({
            ...
            'serverMethod': 'post',
            'ajax': {
                'url': "{{ route('document.process.data-table', ['processId' => $process->id]) }}",
                "data": {
                    "_token": "{{ csrf_token() }}",
                },
            },
