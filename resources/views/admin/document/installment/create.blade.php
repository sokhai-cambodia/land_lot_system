            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        ...
                        <a href="{{ UtilHelper::route('document.installment', ['installmentId' => $installmentId]) }}" class="btn btn-outline-success btn-flat float-right">Document Installment List</a>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" action="{{ route('document.installment.create', ['installmentId' => $installmentId]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
