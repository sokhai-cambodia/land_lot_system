...
class RevenueCostCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('cms.revenue-cost-category.index')->with($data);
    ...
    public function create()
    {
        ...
        return view('cms.revenue-cost-category.create')->with($data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('cms.revenue-cost-category.edit')->with($data);
    }
