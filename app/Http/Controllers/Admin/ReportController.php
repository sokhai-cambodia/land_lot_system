...
{   
    ...
    public function index()
    {
        ...
        return view('admin.report.daily')->with($data);
    }
    ...
    public function printDaily()
    {
        ...
        return view('admin.report.print.daily')->with($data);
    }
    ...
    public function monthly()
    {
        ...
        return view('admin.report.monthly')->with($data);
    }
    ...
    public function printMonthly()
    {
        ...
        return view('admin.report.print.monthly')->with($data);
    }
    ...
    public function printReceipt($id)
    {
        ...
        return view('admin.report.land-layout')->with($data);
    }
    ...
    public function soldLand()
    {
        ...
        return view('admin.report.sold-land')->with($data);
    }
    ...
    public function printSoldLand()
    {
        ...
        return view('admin.report.print.sold-land')->with($data);
    }
