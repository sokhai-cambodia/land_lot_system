...
class LegalServiceController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.legal-service.index')->with($data);
    }
    ...
    public function create($paymentId)
    {
        ...
        return view('admin.legal-service.create')->with($data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.legal-service.edit')->with($data);
    }
    ...
    public function process($id)
    {
        ...
        return view('admin.legal-service.process')->with($data);
    }
    ...
    public function createProcess($id)
    {
        ...
        return view('admin.legal-service.create-process')->with($data);
    }
    ...
    public function editProcess($id, $pid)
    {
        ...
        return view('admin.legal-service.edit-process')->with($data);
    }
