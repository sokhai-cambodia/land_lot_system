...
class LandPaymentController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.land-payment.index')->with($data);
    }
    ...
    public function viewInvoice($id)
    {
        ...
        $content = view('admin.land-payment.view-invoice')->with($data)->render();
    ...
    public function viewReceipt($id)
    {
        ...
        $content = view('admin.land-payment.view-receipt')->with($data)->render();
    ...
    public function create($landId)
    {
        ...
        return view('admin.land-payment.create')->with($data);
    }
    ...
    public function createInstallment($landId)
    {
        ...
        return view('admin.land-payment.create-installment')->with($data);
    }
    ...
    public function generateInstallment(Request $request)
    {
        ...
        $data = view('admin.land-payment.generate-installment')
    ...
    public function installmentList($paymentId)
    {
        ...
        return view('admin.land-payment.installment-list')->with($data);
    }
